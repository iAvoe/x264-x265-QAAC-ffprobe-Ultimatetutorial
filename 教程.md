...
**x264教程**: 封装文件，编码，解码，硬解，软解，码率，滤镜，压制三角形，帧数，小数帧，向量，分辨率换算，GUI，CLI，API，mux，demux，录屏，超频，单核性能，视音频-图像格式分类，色深，浮点色深，色彩空间，宏观色度采样，微观色度采样，色度采样特点，逐行扫描，分行扫描，噪点，拜耳滤镜，RAW格式，视频网站定律，CPU/GPU架构分类，编程语言分类，压制软件用法，报错检查，GOP，动态搜索，运动补偿，SAD，SATD，加权预测，关键帧，参考帧，嫁接帧，参数集，多参考帧，帧内编码，变换-量化，率控制模式，CRF，ABR，CQP，3CQP，zones，VBR，2pass，FTQP，自适应量化，环路滤波，模式决策，率失真优化，率失真曲线，SSE，Noise-SSE，拉格朗日代价，游程编码，色彩信息，压制log，软件下载，去可变帧率，CMD操作，x264 设置参数

**x265教程**: ffmpeg，Vapoursynth，avs2yuv传递参数，ffmpeg字幕渲染，IPCM-CU，U和B的区别，分块，1D傅里叶变换，2D傅里叶变换，二维离散余弦变换，帧间-动态搜索，DMD，Jain & Jain十字搜索，LDSP-SDSP搜索，六边形Hex搜索，不均匀多六边形UMH搜索，搜索迭代与merange的关系，帧间-运动补偿，冲击响应滤镜，小波变换，时域架网-mctf，bilateral filter，显加权预测，隐加权预测，AMVP，merge-mode，GOP结构建立，PPS，SPS，VPS，SS，IDR，CRA，DRA，BLA，RAP，RASL，RADL，帧内编码，3-tap滤镜，强力平滑滤镜，趋平插值模式，夹角插值模式，DC插值模式，对数log(x)，对数-指数交换率，指数增长，上层量化模式，CRF_qScale，ABR_qScale，cplxBlur与qcomp的关系，cplxBase，下层量化模式，近无损压缩，真无损压缩，2pass-ABR，Analysis-2pass-ABR，Analysis-Npass调优模式，Analysis-pass2-ABR-Ladder天梯模式，率失真优化量化，MSE，峰值信噪比PSNR，边界强度，平滑0，平滑1，平滑4，取样迁就偏移，锐-带偏移EO-BO，明暗色深带，中间色深带，振铃，熵编码-算数编码，上下文自适应二进制算数编码-CABAC，SEI，SEI分类，线程节点控制，3D-vCache，多线程vs多参考，色彩空间转换，VUI-HDR调试，软件下载，GCC，RC，for循环批量压制，x265-preset表，x265-tune表，x265 设置参数
...
<font size=3>下载docx版. 在Word或WPS中用「审阅 - 中文简繁转换 - 简转繁」实现; 在LibreOffice中在「工具菜单 - 选项 - 语言选项 - 语言」中启用亚洲语言支持，然后用「工具 - 语言 - 中文简繁转换」完成操作</font>
<br>
 ...
 **x265教程更新2022.24.2**
 <ul>
     <li>[x265 | 综合 精简] 更新 - 变迁:<ul>
        <li>psy-rdoq推荐更新，增加一套实现编码高噪声源的参数搭配</li>
...
<ul>
    ...
    <li>[x264 | 综合 23.5] 科普部分增加了一些Captain Disillustion科普视频的外链<ul>
        ...
        <li>色彩 - 牛顿开挂，视锥细胞，色度采样, 色彩平衡, 调色基础, 调色工具原理, 心理视觉原理, 多媒体调色基础</li>
        <li>分行扫描 - CRT特性-缺陷-标准，超帧率，3 2 pulldown，两种分场"修复"成逐行的方法，不如不修，骂槐adobe</li>
    </ul></li>
