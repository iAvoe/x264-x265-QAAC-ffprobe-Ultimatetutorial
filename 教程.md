...
**x264教程**: 封装文件，编码，解码，硬解，软解，码率，滤镜，压制三角形，帧数，小数帧，向量，分辨率换算，GUI，CLI，API，mux，demux，录屏，超频，单核性能，视音频-图像格式分类，色深，浮点色深，色彩空间，宏观色度采样，微观色度采样，色度采样特点，伽马，伽马矫正，逐行扫描，分行扫描，3:2 pulldown，转逐行与IVTC（field-match，yadif，nnedi滤镜），噪点，抖动，拜耳滤镜，RAW格式，视频网站定律，编程语言分类，压制软件用法，报错检查，GOP，动态搜索，运动补偿，SAD，SATD，加权预测，关键帧，参考帧，嫁接帧，参数集，多参考帧，变换-量化，率控制模式，CRF，ABR，CQP，3CQP，zones，VBR，2pass，FTQP，方差，方差自适应量化（含计算过程），环路滤波，模式决策，率失真优化，率失真曲线，SSE，Noise-SSE，拉格朗日代价，游程编码，色彩信息，压制log，软件下载，去可变帧率，CMD操作，x264 设置参数
